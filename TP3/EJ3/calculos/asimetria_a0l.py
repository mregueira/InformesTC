...
def plot_tolerancia(mode, v1, v2, filename, iteraciones):
    ...
    for it1 in range(iteraciones):
        ...
        for it2 in range(iteraciones):
            a01 = a0 - a0 * tol + 2 * a0 * tol * (it1/iteraciones)
            a02 = a0 - a0 * tol + 2 * a0 * tol * (it2/iteraciones)

            h = transferencias.get_out_a0(v1, v2, a01, a02, a0, a0)
...
plot_tolerancia("mag", 1, 1, filename="asimetria_a0_comun_mag.png", iteraciones=12)
plot_tolerancia("pha", 1, 1, filename="asimetria_a0_comun_pha.png", iteraciones=12)

plot_tolerancia("mag", 1 / 2, -1 / 2, filename="asimetria_a0_dif_mag.png", iteraciones=12)
plot_tolerancia("pha", 1 / 2, -1 / 2, filename="asimetria_a0_dif_pha.png", iteraciones=12)