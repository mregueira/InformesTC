...
v1, v2, vx, vfeed, vout1, vout2, vout, vd, s, a0, wp = sp.symbols("v1 v2 vx vfeed vout1 vout2 vout vd s a0 wp")

r1, r2, r3, r4, r5, r6, r7, r8, r9 = sp.symbols("r1 r2 r3 r4 r5 r6 r7 r8 r9")

h = sp.solve([
    (vout-(vout2-vd) )/r2 - ((vout2-vd)-vout1)/r1,
    vd*(a0/(1+s/wp))-vout,
    (vout1-v1)/r3-(v1-vx)/r4,
    (vfeed-vx)/r5-(vx-v1)/r5-(vx-v2)/r6,
    (vx-v2)/r6-(v2-vout2)/r7,
    vout2*(a0/(1+s/wp))-vfeed],
    (vx, vfeed, vout1, vout2, vout, vd)
)
