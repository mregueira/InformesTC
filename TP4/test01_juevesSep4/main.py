...
class TCExample:
    ...
    def __init__(self):
        ...
        button_phase = Button(toolbar, text="Bode Phase", command=self.plotPhase)
        button_phase.pack(side=LEFT, padx=2,pady=2)
        button_mag = Button(toolbar, text="Bode Mag", command=self.plotMag)
        button_mag.pack(side=RIGHT, padx=2, pady=2)
